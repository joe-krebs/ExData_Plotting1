...
with(power.consum, {
    ## Upper left
    plot(x=datetime, y=Global_active_power, type="l", ylab="Global Active Power", xlab=NA)
    
    ## Upper right
    plot(x=datetime, y=Voltage, type="l")
    
    ## Lower left
    plot(x=datetime, y=Sub_metering_1, type="l", col="black", ylab="Energy sub metering", xlab=NA)
